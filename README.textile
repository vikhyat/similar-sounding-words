...
If you want this to use some other word list, you'll need to download a dictionary for it. Any '.dic' file from "http://wiki.services.openoffice.org/wiki/Dictionaries":http://wiki.services.openoffice.org/wiki/Dictionaries should work. Open setup.rb, change en_US.dic to whatever is appropriate for the file you downloaded, and then run setup.rb. 
